<?php
/**
 * Updated Login Endpoint with IP Tracking
...
try {
    ...
    // Check if user can login (IP restriction)
    ...
    if (!$loginCheck['allowed']) {
        ...
        echo json_encode([
            ...
            "error_code" => "CONCURRENT_SESSION_BLOCKED",
            "details" => [
                "existing_ip" => $loginCheck['existing_ip'],
                "existing_since" => $loginCheck['existing_since'],
                "last_activity" => $loginCheck['last_activity'] ?? null,
    ...
    // Create session record with IP tracking
    ...
    echo json_encode([
        ...
        "session_info" => [
            ...
            "reason" => $loginCheck['reason'] ?? 'Normal login'
        ]
    ]);
